...
void Unicycle::EvaluateInplace(const Eigen::Ref<const VectorXd> &x,
                               const Eigen::Ref<const VectorXd> &u,
                               const float t, Eigen::Ref<VectorXd> xdot) const {
	ALTRO_UNUSED(t);
...
void Unicycle::Jacobian(const Eigen::Ref<const VectorXd>& x,
                                const Eigen::Ref<const VectorXd>& u,
...
void Unicycle::Hessian(const Eigen::Ref<const VectorXd>& x,
                               const Eigen::Ref<const VectorXd>& u,
                               const float t,
